...
{
    class UpdateBasicCalculator : Calculator, BasicCalculatorInterface
    {
        public UpdateBasicCalculator() { }
        public UpdateBasicCalculator(string nm, string power) : base(nm, power)
        {
